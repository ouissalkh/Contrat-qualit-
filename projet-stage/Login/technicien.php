...
$filterActif = (isset($_GET['actif']) && in_array($_GET['actif'], ['vrai', 'faux'], true)) ? $_GET['actif'] : '';
$techniciens = [];
...
// Gestion des champs pour recherche textuelle
$search_clauses = [];
if ($search !== '') {
...
<!-- HTML starts below: remain unchanged except placeholders -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        /* keep your current CSS without duplication, remove one of the style blocks if it's duplicated */
        /* ... your entire style unchanged ... */
    </style>
</head>
<body>
    <style>
...
/* Appliquer le style aux options */
.form-filter-wrapper select option {
...
<div class="container">
    <h1 style="align-items:center;">Liste des techniciens</h1>
    ...
    <form method="get">
        ...
        <a href="<?= htmlspecialchars(basename($_SERVER['PHP_SELF'])) ?>" class="btn" title="Rafraîchir"><i class="fas fa-sync"></i></a>
    </form>
